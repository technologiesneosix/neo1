...
async function resetPasswords() {
  try {
    ...
    const admin2 = await Admin.findOne({ email: 'technologiesneosix@gmail.com' });
    if (admin2) {
      admin2.password = 'NeoSix@12';
      await admin2.save();
      console.log('✅ Password reset for technologiesneosix@gmail.com to NeoSix@12');
    } else {
      ...
      console.log('✅ Created technologiesneosix@gmail.com with password NeoSix@12');
    }
