...
const img = (name, width, height) =>
  `https://placehold.co/${width}x${height}?text=${name}`;
...
export const seedOriginalContent = async () => {
  ...
  const heroSlidesData = [
    {
      ...
      description:
        "Product engineering for companies that ship with confidence.",
  ...
  const servicesData = [
    {
      ...
      shortDescription:
        "High-performance web platforms built on modern frameworks and clean architecture.",
      description:
        "Our web development practice pairs senior engineers with proven delivery playbooks. We start with a short discovery to map goals, constraints and success metrics, then move into iterative delivery with demos every sprint.",
      icon: "Globe",
      order: 1,
      featured: true,
    },
    {
      ...
      shortDescription:
        "Native and cross-platform apps that feel fast, polished and reliable.",
      description:
        "Native and cross-platform apps that feel fast, polished and reliable.",
      icon: "Smartphone",
      order: 2,
    ...
    },
    {
      ...
      shortDescription:
        "Bespoke systems shaped precisely around your operations and workflows.",
      description:
        "Bespoke systems shaped precisely around your operations and workflows.",
      icon: "Code2",
      order: 3,
    ...
    },
    {
      ...
      shortDescription:
        "Multi-tenant products with billing, analytics and scale designed in from day one.",
      description:
        "Multi-tenant products with billing, analytics and scale designed in from day one.",
      icon: "Layers",
      order: 4,
    ...
    },
    {
      ...
      slug: "ui-ux-design",
      shortDescription:
        "Research-driven interfaces that convert, retain and delight.",
      description:
        "Research-driven interfaces that convert, retain and delight.",
      icon: "PenTool",
      order: 5,
    ...
    },
    {
      ...
      slug: "ai-solutions",
      shortDescription:
        "LLM apps, ML pipelines and intelligent automation in production, not slides.",
      description:
        "LLM apps, ML pipelines and intelligent automation in production, not slides.",
      icon: "Brain",
      order: 6,
    ...
    },
    {
      ...
      shortDescription:
        "Architecture, migration and cost optimization on AWS, Azure and GCP.",
      description:
        "Architecture, migration and cost optimization on AWS, Azure and GCP.",
      icon: "Cloud",
      order: 7,
    ...
    },
    {
      ...
      shortDescription:
        "Secure, documented, versioned APIs your partners will enjoy integrating.",
      description:
        "Secure, documented, versioned APIs your partners will enjoy integrating.",
      icon: "Plug",
      order: 8,
    ...
    },
    {
      ...
      slug: "devops",
      shortDescription:
        "CI/CD, infrastructure as code and observability for boring, safe releases.",
      description:
        "CI/CD, infrastructure as code and observability for boring, safe releases.",
      icon: "Workflow",
      order: 9,
    ...
    },
    {
      ...
      shortDescription:
        "SLA-backed monitoring, patching and improvement of live systems.",
      description:
        "SLA-backed monitoring, patching and improvement of live systems.",
      icon: "LifeBuoy",
      order: 10,
  ...
  const solutionsData = [
    {
      ...
      shortDescription:
        "Front desk, housekeeping, channel and revenue management in one platform.",
      description:
        "Front desk, housekeeping, channel and revenue management in one platform.",
      icon: "Hotel",
      order: 1,
    ...
    },
    {
      ...
      slug: "crm-software",
      shortDescription:
        "Pipeline, automation and analytics tailored to how your team actually sells.",
      description:
        "Pipeline, automation and analytics tailored to how your team actually sells.",
      icon: "Users",
      order: 2,
    ...
    },
    {
      ...
      slug: "erp",
      shortDescription:
        "Finance, procurement, inventory and production on a single source of truth.",
      description:
        "Finance, procurement, inventory and production on a single source of truth.",
      icon: "Factory",
      order: 3,
  ...
  const industriesData = [
    ...
    },
    {
      ...
      description:
        "Secure financial technology solutions for banking and payments.",
      icon: "DollarSign",
      order: 2,
    },
    {
      ...
      description:
        "Omnichannel retail solutions and customer experience platforms.",
      icon: "Store",
      order: 3,
    },
    {
  ...
  const projectsData = [
    {
      ...
      description:
        "Built a comprehensive logistics management system with real-time tracking, route optimization, and automated dispatch.",
    ...
    },
    {
      ...
      description:
        "Developed a secure client portal for a fintech company with real-time portfolio analytics, reporting, and compliance features.",
  ...
  const blogPostsData = [
    {
      ...
      excerpt:
        "Best practices for building production-ready React applications that scale.",
      content:
        "Learn how to build scalable React applications with proper state management, performance optimization, and testing strategies.",
    ...
    },
    {
      ...
      content:
        "Explore the latest trends in cloud computing including serverless, edge computing, and multi-cloud strategies.",
  ...
  const testimonialsData = [
    {
      ...
      rating: 5,
      review:
        "Support is the difference. Issues get fixed before our staff notices them. That is what a real partner looks like.",
      featured: true,
      displayOrder: 1,
      status: "active",
    },
    {
      ...
      rating: 5,
      review:
        "The Atlas Freight system transformed our operations. Real-time visibility across our entire fleet.",
      featured: true,
      displayOrder: 2,
      status: "active",
    },
  ...
  const careersData = [
    {
      ...
      description:
        "Join a senior team shipping enterprise products for global clients. You will own features end-to-end, work directly with clients and mentor peers.",
      responsibilities: [
        "Own features from design to production",
        "Write tested, documented code",
    ...
    },
    {
      ...
      description:
        "Join a senior team shipping enterprise products for global clients.",
      responsibilities: [
    ...
    },
    {
      ...
      location: "Mumbai / Noida (Hybrid)",
      description:
        "Learn from senior engineers while working on real projects.",
      responsibilities: [
  ...
  const faqsData = [
    {
      ...
      answer:
        "Every project starts with a free discovery call, followed by a short paid discovery sprint that produces a scoped plan, estimate and timeline you can take anywhere.",
      category: "general",
      displayOrder: 1,
      status: "active",
    },
    {
      ...
      answer:
        "Fixed-scope projects, dedicated teams and staff augmentation. Most clients start fixed-scope and move to a dedicated team as the product grows.",
      category: "services",
      displayOrder: 2,
      status: "active",
    },
    {
      ...
      answer:
        "You do — fully and unambiguously. All work is delivered under a work-for-hire agreement with source code in your repositories from week one.",
      category: "technical",
      displayOrder: 3,
      status: "active",
    },
    {
      ...
      answer:
        "Teams are staffed for at least four hours of overlap with your working day, with async updates and weekly demos keeping everyone aligned.",
      category: "technical",
      displayOrder: 4,
      status: "active",
    },
    {
      ...
      answer:
        "Yes. We begin with a technical audit covering architecture, security and delivery pipelines, then propose a stabilization and improvement roadmap.",
      category: "technical",
      displayOrder: 5,
      status: "active",
    },
    {
      ...
      answer:
        "SLA-backed plans include monitoring, security patching, bug fixes and a monthly improvement budget — with response times as fast as one hour.",
      category: "services",
      displayOrder: 6,
      status: "active",
    },
    {
      ...
      answer:
        "Of course. We are happy to sign your NDA before any detailed conversation about your product.",
      category: "general",
      displayOrder: 7,
      status: "active",
    },
    {
      ...
      answer:
        "Transparent, milestone-based billing. You see progress in a live dashboard and approve each milestone before payment.",
      category: "services",
      displayOrder: 8,
      status: "active",
    },
  ...
  await Service.insertMany(
    servicesData.map((item) => ({ ...item, status: "published" })),
  );
  console.log("✓ Services seeded");

  await Solution.insertMany(
    solutionsData.map((item) => ({ ...item, status: "published" })),
  );
  console.log("✓ Solutions seeded");

  await Industry.insertMany(
    industriesData.map((item) => ({ ...item, status: "published" })),
  );
  console.log("✓ Industries seeded");

  await Technology.deleteMany({});
  await Technology.insertMany(
    technologiesData.map((item) => ({ ...item, status: "published" })),
  );
  console.log("✓ Technologies seeded");

  await Project.insertMany(
    projectsData.map((item) => ({ ...item, status: "published" })),
  );
