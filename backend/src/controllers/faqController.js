...
export const getFAQById = async (req, res, next) => {
  try {
    ...
    return res.status(200).json(
      ApiResponse.success('FAQ retrieved successfully', faq)
    );
  } catch (error) {
    next(error);
  }
...
export const updateFAQStatus = async (req, res, next) => {
  try {
    ...
    return res.status(200).json(
      ApiResponse.success('FAQ status updated successfully', faq)
    );
  } catch (error) {
    next(error);
  }
...
export const updateFAQDisplayOrder = async (req, res, next) => {
  try {
    ...
    return res.status(200).json(
      ApiResponse.success('FAQ display order updated successfully', faq)
    );
  } catch (error) {
    next(error);
  }
...
export const deleteFAQ = async (req, res, next) => {
  try {
    ...
    return res.status(200).json(
      ApiResponse.success('FAQ deleted successfully')
    );
  } catch (error) {
    next(error);
  }
