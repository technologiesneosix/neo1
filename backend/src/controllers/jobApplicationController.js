...
export const createJobApplication = async (req, res, next) => {
  try {
    ...
    const status = req.body.status === 'new' ? 'pending' : req.body.status || 'pending';
...
export const getJobApplicationById = async (req, res, next) => {
  try {
    ...
    return res.status(200).json(
      ApiResponse.success('Job application retrieved successfully', application)
    );
  } catch (error) {
    next(error);
  }
...
export const updateJobApplication = async (req, res, next) => {
  try {
    ...
    return res.status(200).json(
      ApiResponse.success('Job application updated successfully', application)
    );
  } catch (error) {
    next(error);
  }
...
export const deleteJobApplication = async (req, res, next) => {
  try {
    ...
    return res.status(200).json(
      ApiResponse.success('Job application deleted successfully')
    );
  } catch (error) {
    next(error);
  }
