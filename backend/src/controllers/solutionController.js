...
export const createSolution = async (req, res, next) => {
  try {
    ...
    return res.status(201).json(
      ApiResponse.success('Solution created successfully', solution)
    );
  } catch (error) {
    next(error);
  }
...
export const getAllSolutions = async (req, res, next) => {
  try {
    const { page = 1, limit = 10, status, search, industry, technology } = req.query;
...
export const updateSolution = async (req, res, next) => {
  try {
    ...
    return res.status(200).json(
      ApiResponse.success('Solution updated successfully', solution)
    );
  } catch (error) {
    next(error);
  }
...
export const deleteSolution = async (req, res, next) => {
  try {
    ...
    return res.status(200).json(
      ApiResponse.success('Solution deleted successfully')
    );
  } catch (error) {
    next(error);
  }
