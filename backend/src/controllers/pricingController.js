...
export const createPricingPlan = async (req, res, next) => {
  try {
    ...
    return res
      .status(201)
      .json(ApiResponse.success("Pricing Plan created successfully", plan));
  } catch (error) {
    next(error);
  }
};
...
export const getPricingPlanById = async (req, res, next) => {
  try {
    ...
    return res
      .status(200)
      .json(ApiResponse.success("Pricing Plan retrieved successfully", plan));
  } catch (error) {
    next(error);
  }
};
...
export const updatePricingPlan = async (req, res, next) => {
  try {
    ...
    return res
      .status(200)
      .json(ApiResponse.success("Pricing Plan updated successfully", plan));
  } catch (error) {
    next(error);
  }
};
...
export const deletePricingPlan = async (req, res, next) => {
  try {
    ...
    return res
      .status(200)
      .json(ApiResponse.success("Pricing Plan deleted successfully"));
  } catch (error) {
    next(error);
  }
};
