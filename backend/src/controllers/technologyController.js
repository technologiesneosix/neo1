...
export const createTechnology = async (req, res, next) => {
  try {
    ...
    return res
      .status(201)
      .json(ApiResponse.success("Technology created successfully", technology));
  } catch (error) {
    next(error);
  }
};
...
export const updateTechnology = async (req, res, next) => {
  try {
    ...
    const technology = await Technology.findByIdAndUpdate(id, updateData, {
      new: true,
      runValidators: true,
    });
    ...
    return res
      .status(200)
      .json(ApiResponse.success("Technology updated successfully", technology));
  } catch (error) {
    next(error);
  }
};
...
export const updateTechnologyStatus = async (req, res, next) => {
  try {
    ...
    return res
      ...
      .json(
        ApiResponse.success(
          "Technology status updated successfully",
          technology,
        ),
      );
  } catch (error) {
...
export const updateTechnologyDisplayOrder = async (req, res, next) => {
  try {
    ...
    logger.info(
      `Technology display order updated: ${technology.name} - ${order}`,
    );
    ...
    return res
      ...
      .json(
        ApiResponse.success(
          "Technology display order updated successfully",
          technology,
        ),
      );
  } catch (error) {
...
export const deleteTechnology = async (req, res, next) => {
  try {
    ...
    return res
      .status(200)
      .json(ApiResponse.success("Technology deleted successfully"));
  } catch (error) {
    next(error);
  }
};
